...
export const blogPosts = [
  {
    ...
    excerpt: 'THC-X je nová generace synteticky odvozených kanabinoidů s unikátní chemickou strukturou. Zjistěte vše o jeho složení, vlastnostech a právním statusu v ČR.',
    category: 'Vzdělání',
...
THC-X produkty jsou prodávány výhradně jako sběratelské předměty pro dospělé. Nejsou určeny ke konzumaci, spalování ani kouření. Slouží k průmyslovým, technickým a zahradnickým účelům.
  ...
  },
  {
    ...
    excerpt: 'Rozdíl mezi indicou, sativou a hybridem není jen v tvaru listu. Jde o celý profil terpénů a kanabinoidů, který určuje botanický charakter odrůdy.',
    category: 'Průvodce',
    ...
    image: null,
    content: `
Klasické dělení na indica, sativu a hybrid pochází z botaniky 18. století. Dnes víme, že skutečný botanický charakter neurčuje "typ" rostliny, ale chemický profil — tedy poměr kanabinoidů a terpénů.
...
Charakteristická vyšším obsahem limonenu, terpinolenu a α-pinenu. Botanicky se vyznačuje štíhlejší strukturou a delšími květními hrozny.
...
Místo typu se zaměřte na terpénový profil v produktovém popisu. Na Tajné Botanice uvádíme přesné složení každého produktu.
  ...
  },
  {
    ...
    excerpt: 'Terpény jsou organické sloučeniny zodpovědné za aroma každé odrůdy. Jejich unikátní kombinace určuje aromatický a botanický charakter každého sběratelského květu.',
    category: 'Věda',
...
Nepoužívejte plastové sáčky — statická elektřina poškozuje povrch květu. Neuchovávejte v mrazáku — narušuje botanickou integritu. Skladujte odrůdy odděleně — zachováte čistotu aromatického profilu.

## Trvanlivost

Při správném skladování vydrží produkt plně aromatický 6–12 měsíců. Po roce začíná oxidace a postupná degradace kanabinoidů.
    `,
  },
  {
    slug: 'thc-x-vs-hhc-rozdily',
    title: 'THC-X vs HHC: Klíčové rozdíly, které musíte znát',
    excerpt: 'THC-X a HHC jsou dva populární kanabinoidy s odlišnou chemickou strukturou a sběratelskou hodnotou. Porovnáváme je bod po bodu.',
    category: 'Srovnání',
...
THC-X je hexylový ester THC-O-acetátu — chemicky unikátní derivát s vyšší koncentrací kanabinoidů a vzácnějším profilem.
...
Produkty jsou prodávány výhradně jako sběratelské předměty pro osoby starší 18 let. Nejsou určeny ke konzumaci, spalování ani kouření.
  ...
  },
  {
    ...
    title: 'CBD květy: Legální alternativa pro sběratele',
    excerpt: 'CBD květy jsou plně legální v ČR a nabízejí unikátní botanické vlastnosti. Co je CBD, jaké má chemické složení a proč je mezi sběrateli stále populárnější.',
    category: 'Vzdělání',
